...
\caption{\label{tab:bm1_results}BM1 free-field validation: focal pressure converges toward the analytical solution with decreasing grid spacing.}
\centering
\begin{tabular}[t]{rrrrr}
\toprule
dx (mm) & Focus (kPa) & Analytical (kPa) & Error (\%) & Time (s)\\
\midrule
0.50 & 562 & 1005 & 44.1 & 24\\
0.25 & 881 & 1005 & 12.4 & 455\\
\bottomrule
\end{tabular}
\end{table}
...
\caption{\label{tab:bm7_results}BM7 realistic skull simulation on A100. The 10.5M-point grid at dx=1\,mm solves in under 2 minutes.}
\centering
\begin{tabular}[t]{rlllrr}
\toprule
dx (mm) & Grid & Skull voxels & Brain voxels & Peak $p_{\text{amp}}$ (kPa) & Time (s)\\
\midrule
...
\caption{\label{tab:phase_correction}Phase correction through skull (16 elements, 50 steps). Recovery improves from 22\% to 33\% at finer resolution.}
\centering
...
\caption{\label{tab:birnbaum_sim}Per-patient Helmholtz simulation through expert-segmented stroke patient skulls (Birnbaum dataset, dx=2\,mm). The 20$\times$ variation in focal pressure demonstrates the importance of per-subject skull modeling.}
\centering
\begin{tabular}[t]{lrrr}
\toprule
Subject & Skull (\%) & Brain $p_{\max}$ (kPa) & Time (s)\\
\midrule
GU002 & 11.7 & 1.0 & 9.4\\
GU006 & 12.6 & 0.4 & 7.6\\
GU008 & 14.9 & 4.6 & 9.6\\
...
\caption{\label{tab:birnbaum_cohort}Birnbaum cohort skull analysis: 64 subjects across 4 clinical sites. Pseudo-CT Dice (mean $\pm$ SD) confirms the limitation of threshold-based T1-only skull segmentation.}
\centering
\begin{tabular}[t]{lrlll}
\toprule
Cohort & N & Skull vol (voxels) & Thickness (mm) & Pseudo-CT Dice\\
\midrule
GU & 28 & 1468758.5 +/- 319798.7 & 22.3 +/- 3.2 & 0.2 +/- 0.1\\
NC & 22 & 2135822.7 +/- 323593 & 27.2 +/- 2.4 & 0.2 +/- 0\\
NYU & 10 & 1800096.5 +/- 277270.2 & 21.9 +/- 3.4 & 0.2 +/- 0\\
other & 4 & 1960486 +/- 657518.5 & 25.8 +/- 4.9 & 0.1 +/- 0\\
\bottomrule
\end{tabular}
\end{table}
